...
\begin{enumerate}
\item 求证：如$T$是保范数的，则$T$是保角的。

\item 如$\real^n$有一基底$x_1, \cdots, x_n$, 又有数$\lambda_1, \cdots, \lambda_n$使得$Tx_i = \lambda_ix_i$,求证$T$是保角的，当且仅当所有$|\lambda_i|$皆相等。

\item 所有保角的$T: \real^n \to \real^n$是些什么？
